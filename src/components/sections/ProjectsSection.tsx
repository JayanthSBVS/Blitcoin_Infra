...
const projects = [
  {
    ...
    desc: 'A landmark residential complex setting new standards for premium urban living.',
    tags: ['Quality', 'High-Rise', 'Curated Amenities'],
    image: '/assets/images/real_residential.png',
  },
  {
    id: 2, title: 'Nexus Business Hub', category: 'Commercial',
    location: 'Hyderabad, TG', year: '2023', area: '850K sq.ft', status: 'Completed',
    desc: 'A premium commercial campus designed for enterprise-grade operations.',
    tags: ['Corporate', 'Strategic', 'Sustainable'],
    image: '/assets/images/real_commercial.png',
  },
  {
    id: 3, title: 'Greenfield Township', category: 'Township',
    location: 'Hyderabad, TG', year: '2024', area: '120 acres', status: 'Ongoing',
    desc: 'An integrated 120-acre township with residential units, retail, and smart infrastructure.',
    tags: ['Community', 'Mixed-Use', 'Green'],
    image: '/assets/images/real_construction.png',
  },
  {
    id: 4, title: 'Azure Apartments', category: 'Residential',
    location: 'Hyderabad, TG', year: '2023', area: '480K sq.ft', status: 'Completed',
    desc: 'Premium mid-rise apartments with curated community spaces and reliable structural safety.',
    tags: ['Mid-Rise', 'Amenity-Rich', 'Community'],
    image: '/assets/images/real_residential.png',
  },
  {
    id: 5, title: 'The Pinnacle Tower', category: 'Commercial',
    location: 'Hyderabad, TG', year: '2024', area: '1.2M sq.ft', status: 'Ongoing',
    desc: 'A modern commercial tower reshaping the local skyline with robust architecture.',
    tags: ['High-Rise', 'Premium Office', 'Modern Design'],
    image: '/assets/images/real_commercial.png',
  },
  {
    id: 6, title: 'Modern Zen Interior', category: 'Interior',
    location: 'Hyderabad, TG', year: '2023', area: '12K sq.ft', status: 'Completed',
    desc: 'A meticulously designed interior maximizing spatial ergonomics and modern design.',
    tags: ['Custom Workwood', 'Interior', 'Ergonomic'],
